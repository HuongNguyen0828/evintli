  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-900 to-teal-900 text-white">
      ...
      <div className="mt-6 flex space-x-4">
        <a href="/login" className="px-6 py-2 bg-blue-600 rounded text-white hover:bg-blue-700">Login</a>
        <a href="/signup" className="px-6 py-2 bg-white text-blue-600 rounded hover:bg-gray-100">Sign Up</a>
      </div>
    </main>
  );
}